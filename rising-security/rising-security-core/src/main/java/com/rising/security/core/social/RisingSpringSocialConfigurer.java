...
public class RisingSpringSocialConfigurer extends SpringSocialConfigurer {
    ...
    * */
    ...
    public RisingSpringSocialConfigurer(String filterProcessesUrl) {
     ...
     * 创建：李启云
     * 日期：2020-12-10
     * 描述：T 其实就是指的SocialAuthenticationFilter类型
     *
     * @param object 对象
     * @return {@link T }
     */
