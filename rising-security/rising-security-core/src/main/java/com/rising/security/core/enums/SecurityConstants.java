...
public interface SecurityConstants {
     ...
     * 默认登录页面
     */
    String DEFAULT_LOGIN_PAGE_URL = "/rising-login.html";
    /**
     ...
     * session失效默认的跳转地址
     */
    String DEFAULT_SESSION_INVALID_URL = "/rising-session-invalid.html";
    /**
     * 默认的注册url
     */
    String DEFAULT_SIGNUP_URL = "/rising-signUp.html";
    /**
     * 获取第三方账号的用户信息对应的url
     */
