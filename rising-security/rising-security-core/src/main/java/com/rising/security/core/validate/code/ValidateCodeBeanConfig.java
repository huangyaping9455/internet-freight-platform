...
import com.rising.security.core.validate.code.image.ImageCodeGenerator;
import com.rising.security.core.validate.code.sms.DefaultSmsCodeSender;
import com.rising.security.core.validate.code.sms.SmsCodeSender;
...
/**
 * 描述：Validate code bean config
 * 创建时间：2020-01-31 11:58:13
 * 创建作者：李启云
 */
@Configuration
