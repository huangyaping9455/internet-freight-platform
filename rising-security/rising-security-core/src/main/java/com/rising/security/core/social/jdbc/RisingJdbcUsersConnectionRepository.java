//package com.rising.security.core.social.jdbc;
//
...
// * The supporting schema is defined in RisingJdbcUsersConnectionRepository.sql.
// * @author Keith Donald
// */
//public class RisingJdbcUsersConnectionRepository implements UsersConnectionRepository {
//
...
//
//    public RisingJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
...
//        }
//        return new RisingJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
//    }
//
//}
