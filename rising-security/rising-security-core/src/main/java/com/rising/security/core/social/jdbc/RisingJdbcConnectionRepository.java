...
//
//public class RisingJdbcConnectionRepository implements ConnectionRepository {
//
...
//
//	public RisingJdbcConnectionRepository(String userId, JdbcTemplate jdbcTemplate, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor, String tablePrefix) {
//		this.userId = userId;
