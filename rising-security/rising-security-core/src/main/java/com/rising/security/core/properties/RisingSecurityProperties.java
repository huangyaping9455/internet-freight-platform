...
@Data //不用写get set方法了
@ConfigurationProperties(prefix = "rising.security") //指定以rising.security开头的配置会射入到该类中
public class RisingSecurityProperties {
    /***封装浏览器相关的属性*/
    ...
    /***springsocial相关的配置*/
    private RisingSocialProperties social = new RisingSocialProperties();
