package com.rising.security.app.controller;

import com.rising.security.app.utils.AppSignUpUtils;
import com.rising.security.core.pojo.SocialUserInfo;
...
/**
 * 描述：将社交账户从session转存到redis，并返回给APP一个
 * * 社交登陆失败的原因+社交账户信息（便于APP前端显示当前社交账户的用户名、头像等信息）
 * 创建时间：2020-02-01 21:12:02
 * 创建作者：李启云
 */
@RestController
